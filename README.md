...
| <img width="36" height="384" alt="image" src="https://github.com/user-attachments/assets/8620753d-5ecb-4536-88d4-9f15ff32bd66" /> |assignment_return| `#FAB932` | `FILL 0`, `wght 700`, `GRAD 200`, `opsz 40`     | `Restituída AUDITORIA` | 
| <img width="36" height="384" alt="image" src="https://github.com/user-attachments/assets/8620753d-5ecb-4536-88d4-9f15ff32bd66" />     |assignment_return|`#FAB932` | `FILL 1`, `wght 700`, `GRAD 200`, `opsz 40`     | `Restituída  JSD` |
